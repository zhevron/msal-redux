        ...
        switch (_a.label) {
            ...
            case 1:
                ...
                return [4 /*yield*/, effects_1.put({
                        ...
                        scopes: scopes,
                        user: __assign({}, (new Types.MsalUser(null, null, null, null)), userAgentApplication.getUser(), { roles: decodedToken.roles || [] }),
                    })];
            case 2:
                _a.sent();
                return [3 /*break*/, 5];
...
function signIn(action) {
    var scopes, popup, accessToken, error_2;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
...
function msalSaga(clientId, authority, options) {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                mergedOptions = __assign({ redirectUri: window.location.origin + "/" }, options);
